...
on({id: 'javascript.0.Camera_Eingang_Trigger.triggered_Bild', change: "any"}, function (obj) {
   

    // telegram senden
    sendTo('telegram.0','/opt/iobroker_scripte_axel/send.jpg');
    console.log('____ Eingang Bild gesendet');
