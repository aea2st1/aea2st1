...
/***** 1. Tasmota-Config *****/
    ...
    const NSPanelReceiveTopic: string = 'mqtt.1.SmartHome.NSPanel_1.tele.RESULT';
    const NSPanelSendTopic: string = 'mqtt.1.SmartHome.NSPanel_1.cmnd.CustomSend';
...
//<PageItem>{ id: 'alias.0.NSPanel_1.CardChartExample', name: 'Luftreiniger', icon: 'power', icon2: 'power',offColor: MSRed, onColor: MSGreen},
let Temperaturen = <PageGrid>  
{
    ...
    'useColor': true,
    'items': [
        <PageItem>{ id:  'alias.0.NSPanel.Temperatur.TemperaturAussen', name: 'Aussen', fontSize: 3, unit: '°C', offColor: MSRed, onColor: MSGreen, useValue: true, colorScale: {'val_min': -20, 'val_max': 40, 'val_best': 20} },
        <PageItem>{ id:  'alias.0.NSPanel.Temperatur.Temperatur_UG_Werkstatt', name: 'Werkstatt', fontSize: 3, unit: '°C', offColor: MSRed, onColor: MSGreen, useValue: true, colorScale: {'val_min': -20, 'val_max': 40, 'val_best': 20} },
        <PageItem>{ id:  'alias.0.NSPanel.Temperatur.Temperatur_UG_Heizungskeller', name: 'Heizung', fontSize: 3, unit: '°C', offColor: MSRed, onColor: MSGreen, useValue: true, colorScale: {'val_min': -20, 'val_max': 40, 'val_best': 20} },
        <PageItem>{ id:  'alias.0.NSPanel.Temperatur.Temperatur_EG_Wohnzimmer', name: 'EG_Wohn', fontSize: 3, unit: '°C', offColor: MSRed, onColor: MSGreen, useValue: true, colorScale: {'val_min': -20, 'val_max': 40, 'val_best': 20} },
        <PageItem>{ id:  'alias.0.NSPanel.Temperatur.Temperatur_EG_Bad', name: 'EG_Bad', fontSize: 3, unit: '°C', offColor: MSRed, onColor: MSGreen, useValue: true, colorScale: {'val_min': -20, 'val_max': 40, 'val_best': 20} },
        <PageItem>{ id:  'alias.0.NSPanel.Temperatur.Temperatur_EG_Schlafzimmer', name: 'EG_Schlaf', fontSize: 3, unit: '°C', offColor: MSRed, onColor: MSGreen, useValue: true, colorScale: {'val_min': -20, 'val_max': 40, 'val_best': 20} },

   ]
}; 

// Anzeige der aktuell verbrauchten Energie  
let Energie = <PageGrid> 
{
    'type': 'cardGrid',  
    'heading': 'Energie',
    'useColor': true,  
    'items': [   
        <PageItem>{ id:  'alias.0.NSPanel.Energie.Energie_UG_Haustechnik', name: 'Haustechnik', fontSize: 3, unit: '°C',useValue: true},
        <PageItem>{ id:  'alias.0.NSPanel.Energie.Energie_DG', name: 'DG', fontSize: 3, useValue: true},
        <PageItem>{ id:  'alias.0.NSPanel.Temperatur', name: 'Werkstatt', fontSize: 3, unit: '°C', offColor: MSRed, onColor: MSGreen, useValue: true, colorScale: {'val_min': -20, 'val_max': 40, 'val_best': 20} },
        <PageItem>{ id:  'alias.0.NSPanel.Energie.Energie_EG', name: 'EG', fontSize: 3, useValue: true},        
        <PageItem>{ id:  'alias.0.NSPanel.Energie.Energie_OG', name: 'OG', fontSize: 3, useValue: true},        
        <PageItem>{ id:  'alias.0.NSPanel.Energie.Energie_DG', name: 'DG', fontSize: 3, useValue: true},
    ]
}; 
...
let NSPanel_Service = <PageEntities>
{
    ...
    'useColor': true,
    'items': [
        <PageItem>{ navigate: true, id: 'NSPanel_Infos', icon: 'information-outline', offColor: Menu, onColor: Menu, name: findLocaleServMenu('infos_'), buttonText: findLocaleServMenu('more')},
 ...
 ***********************************************************************/
    leftScreensaverEntity:
        [
            {
                ScreensaverEntity: '0_userdata.0.Gaszähler.Tag',
                ScreensaverEntityFactor: 1,
                ScreensaverEntityDecimalPlaces: 1,
                ScreensaverEntityIconOn: 'gas-burner',
                ScreensaverEntityIconOff: null,
                ScreensaverEntityText: 'Gas',
                ScreensaverEntityUnitText: ' m3/Tag',
                ScreensaverEntityIconColor: {'val_min': 0, 'val_max': 35, 'val_best': 22}
            },            {
                ScreensaverEntity: 'shelly.0.SHEM-3#C45BBE6C0DD9#1.Emeter1.Power',
                ScreensaverEntityFactor: 1,
                ScreensaverEntityDecimalPlaces: 1,
                ScreensaverEntityIconOn: 'power-plug',
                ScreensaverEntityIconOff: null,
                ScreensaverEntityText: 'Tempera ur',
                ScreensaverEntityUnitText: ' W',
                ScreensaverEntityIconColor: {'val_min': 0, 'val_max': 35, 'val_best': 22}
            },            {
                ScreensaverEntity: 'shelly.0.SHEM-3#244CAB435D22#1.Emeter1.Power',
                ScreensaverEntityFactor: 1,
                ScreensaverEntityDecimalPlaces: 1,
                ScreensaverEntityIconOn: 'power-plug',
                ScreensaverEntityIconOff: null,
...
{ 
    ...
    mrIcon1ScreensaverEntity: 
        { 
            ScreensaverEntity: 'mqtt.1.SmartHome.NSPanel_1.stat.POWER1', 
    ...
    mrIcon2ScreensaverEntity: 
        { 
            ScreensaverEntity: 'mqtt.1.SmartHome.NSPanel_1.stat.POWER2', 
            ScreensaverEntityIconOn: 'lightbulb',
            ScreensaverEntityIconOff: 'lightbulb-outline', 
            ScreensaverEntityValue: null,
            ScreensaverEntityValueDecimalPlace : 0,
...
//    mrIcon2ScreensaverEntity: { ScreensaverEntity: null, ScreensaverEntityIcon: null, ScreensaverEntityOnColor: On, ScreensaverEntityOffColor: Off  },
    ...
    button1: {
        // DE: Mögliche erte wenn Rule2 definiert: 'page', 'toggle', 'set' - Wenn nicht definiert --> mode: null
